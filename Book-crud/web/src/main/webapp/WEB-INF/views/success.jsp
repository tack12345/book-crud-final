...
<body>
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#e3f2fd;">
		...
		<div class="alert alert-success" role="alert" style="font-size: 40px; overflow:hidden;">
		<div class="bg-image" style="background-image: url('https://img.freepik.com/free-photo/glasses-pile-books_23-2148213845.jpg?size=626&ext=jpg&ga=GA1.1.1914462841.1681188686&semt=ais'); background-size:cover; background-position:center; height:100vh; ">
